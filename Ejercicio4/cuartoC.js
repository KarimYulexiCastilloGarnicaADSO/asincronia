// Aquí se define una función llamada cargarDatos. Esta función utiliza la palabra clave async para 
//indicar que contiene operaciones asincrónicas.
...
//Llama a la función cargarDatos, espera a que se resuelva la promesa y luego maneja los resultados o errores
...
cargarDatos()
    .then(resultado => {
        ...
        tableData.sort((a, b) => a.repository.localeCompare(b.repository));
